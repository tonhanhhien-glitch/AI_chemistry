...
_FIELDS: dict[str, tuple[str, PropertyCategory, str | None, str, str]] = {
    "MolecularWeight": ("pubchem_molecular_weight", PropertyCategory.PHYSICAL, "g/mol", "Khối lượng phân tử (PubChem)", "Molecular weight (PubChem)"),
    ...
    "Charge": ("pubchem_charge", PropertyCategory.IDENTITY, None, "Điện tích (PubChem)", "Charge (PubChem)"),
