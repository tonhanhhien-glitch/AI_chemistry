...
- [x] Run full backend test set.
- [x] Validate all curated molecules.
...
- [x] Write `deploy_notes.md` with the concrete step-by-step deploy process once the provider is chosen.
