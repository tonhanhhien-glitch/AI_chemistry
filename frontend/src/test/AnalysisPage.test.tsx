...
describe("AnalysisPage", () => {
  ...
  it("resubmits an ambiguous PubChem formula with the selected CID", async () => {
    ...
    await userEvent.click(screen.getByRole("button", { name: "Phân tích" }));
    ...
    expect(analyzeMolecule).toHaveBeenLastCalledWith(expect.objectContaining({ formula: "NF3", pubchem_cid: 1 }));
  });
});
