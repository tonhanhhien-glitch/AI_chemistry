...
describe("AnalysisPage", () => {
  ...
  it("resubmits an ambiguous PubChem formula with the selected CID", async () => {
    ...
    expect(analyzeMolecule).toHaveBeenLastCalledWith(expect.objectContaining({ formula: "NF3", pubchem_cid: 1 }), expect.any(AbortSignal));
  });
});
